...
import { quickTestimonials, trustStats } from "@/core/data/testimonials";

const TrustSection = () => {
  const stats = [
    { icon: Star, value: "4.9", label: "TripAdvisor Rating", sublabel: "Based on 312 reviews" },
    { icon: Users, value: `${trustStats.happyTravelers}+`, label: "Happy Travelers", sublabel: "Since 2015" },
    { icon: Shield, value: `${trustStats.safetyRecord}%`, label: "Safety Record", sublabel: "Licensed & Insured" },
    { icon: Award, value: `${trustStats.industryAwards}+`, label: "Industry Awards", sublabel: "Excellence Recognition" }
  ];
  ...
  const testimonials = quickTestimonials;
