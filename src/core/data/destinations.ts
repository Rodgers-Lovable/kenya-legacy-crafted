...
export const destinations = [
  {
    ...
    rating: 4.9,
    safariCount: 12,
    activities: ["Game Drives", "Hot Air Balloon Safaris", "Cultural Visits", "Night Game Drives"],
    accommodation: ["Luxury Tented Camps", "Mid-range Lodges", "Budget Camps", "Mobile Camps"],
    uniqueFeatures: ["Annual Great Migration", "Highest concentration of big cats", "Maasai cultural interaction", "Mara River crossings"],
  ...
  },
  {
    ...
    rating: 4.7,
    safariCount: 6,
    activities: ["Game Drives", "River Walking", "Cultural Visits", "Bird Watching", "Camel Safaris"],
    accommodation: ["Luxury Tented Camps", "Mid-range Lodges", "Eco-lodges", "Budget Camps"],
    uniqueFeatures: ["Samburu Special Five", "Ewaso Nyiro River ecosystem", "Semi-arid landscapes", "Authentic cultural experiences"],
  ...
  },
  {
    ...
    wildlife: ["Mountain Bongo", "Black & White Colobus", "Elephants", "Buffalo", "Sykes Monkeys"],
    rating: 4.3,
    safariCount: 4,
    activities: ["Mountain Climbing", "Trekking", "Wildlife Viewing", "Bird Watching", "Forest Walks"],
    accommodation: ["Mountain Lodges", "Alpine Huts", "Forest Camps", "Self-catering Bandas"],
    uniqueFeatures: ["Africa's second highest peak", "Unique alpine ecosystems", "Mountain bongo antelope", "Glacial valleys and lakes"],
    detailedDescription: "Mount Kenya National Park protects the region around Mount Kenya, Africa's second highest peak at 5,199 meters. This UNESCO World Heritage Site features diverse ecosystems from montane forest to alpine zones, supporting unique species like the endangered mountain bongo antelope. The park offers world-class trekking and climbing opportunities with multiple routes to Point Lenana (4,985m) and technical climbs to Batian and Nelion peaks. The pristine mountain environment supports over 130 bird species and diverse high-altitude wildlife."
  },
  {
