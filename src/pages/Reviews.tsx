...
const Reviews = () => {
  ...
  const platforms = [
    { name: "TripAdvisor", rating: 4.9, reviews: 312, badge: "Certificate of Excellence" },
    { name: "Google Reviews", rating: 4.8, reviews: 267, badge: "Top Rated" },
    { name: "SafariBookings", rating: 4.9, reviews: 189, badge: "Preferred Partner" },
    ...
    <div className="min-h-screen pt-16">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              Real stories from travelers who've experienced the magic of Kenya with us
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-sm opacity-80">{stats.totalReviews} reviews across all platforms</p>
              </div>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                {platforms.map((platform) => (
                  <div key={platform.name} className="bg-white/10 backdrop-blur-sm rounded-card p-4">
                    <div className="font-semibold text-sm">{platform.name}</div>
                    <div className="flex items-center justify-center mt-1">
                      <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 mr-1" />
                      <span className="text-sm">{platform.rating}</span>
                    </div>
                    <div className="text-xs opacity-80">{platform.reviews} reviews</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {reviews.map((review) => (
              <Card key={review.id} className="group hover:shadow-safari-floating transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center">
                      {review.verified && (
                        <Badge variant="secondary" className="mr-2 text-xs">Verified</Badge>
                      )}
                      <div className="flex">
                  ...
                  <div className="relative mb-4">
                    ...
                    <h4 className="font-semibold text-primary mb-2 ml-6">{review.title}</h4>
                  ...
                  <div className="border-t border-border pt-4">
                    <div className="text-xs font-medium text-primary mb-2">Safari Experience:</div>
                    <div className="text-sm text-muted-foreground mb-3">{review.safari}</div>
      ...
      <section className="py-20 bg-muted/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl mb-4">Trusted Across Platforms</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our commitment to excellence is reflected in consistently high ratings across all major review platforms
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {platforms.map((platform) => (
              <Card key={platform.name} className="text-center hover:shadow-safari-floating transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">{platform.reviews} reviews</p>
      ...
      <section className="py-20 bg-gradient-sunset text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-3xl mb-4">Ready to Create Your Own Story?</h2>
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Join hundreds of satisfied travelers who've experienced the magic of Kenya with us
          </p>
