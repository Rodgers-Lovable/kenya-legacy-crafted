...
const Reviews = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Top Reviews | {COMPANY_NAME}</title>
      </Helmet>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <p className="text-xl mb-8 opacity-90">
                  Real stories from travelers who've experienced the magic of
                  Kenya with us
                </p>
        ...
        <section className="py-20 bg-gradient-sunset text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join hundreds of satisfied travelers who've experienced the magic
              of Kenya with us
            </p>
