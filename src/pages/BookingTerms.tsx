...
const BookingTerms = () => {
  ...
  const paymentSchedule = [
    {
      ...
      description: "Non-refundable deposit to secure your safari",
    },
    {
      stage: "Final Payment",
      percentage: "70%",
      timing: "60 days before travel",
      description: "Remaining balance due before departure",
    },
    {
      stage: "Last-Minute Bookings",
      percentage: "100%",
      timing: "Within 60 days",
      description:
        "Full payment required for bookings made less than 60 days before travel",
    },
  ];

  const cancellationPolicy = [
    {
      period: "More than 60 days",
      charge: "10%",
    ...
    },
    {
      period: "31-60 days",
      charge: "25%",
      description: "Quarter of total cost",
    },
    { period: "15-30 days", charge: "50%", description: "Half of total cost" },
    {
      period: "8-14 days",
      charge: "75%",
      description: "Three-quarters of total cost",
    },
    {
      period: "7 days or less",
      charge: "100%",
      description: "Full cost, no refund",
    },
  ...
  return (
    <>
      <Helmet>
        <title>Booking Terms | {COMPANY_NAME}</title>
        <meta
          name="description"
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-4 opacity-90">
                Complete booking terms, payment policies, and conditions for
            ...
            <div className="max-w-4xl mx-auto">
              <Alert className="border-blue-200 bg-blue-50">
                ...
                <AlertDescription className="text-blue-800">
                  <strong>Please Note:</strong> These booking terms apply to all
                  safari packages and services. By confirming your booking, you
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <CardContent className="p-0">
                  <div className="divide-y divide-border">
                    {cancellationPolicy.map((policy, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-6 hover:bg-muted/20 transition-safari"
                      >
                        <div>
                          <h4 className="font-semibold">
                            {policy.period} before departure
                          </h4>
              ...
              <Alert className="mt-6 border-amber-200 bg-amber-50">
                ...
                <AlertDescription className="text-amber-800">
                  <strong>Travel Insurance Recommended:</strong> We strongly
                  recommend comprehensive travel insurance to protect against
                  unforeseen circumstances that may require cancellation.
                </AlertDescription>
              </Alert>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h2 className="font-display text-3xl mb-4">
                Questions About Booking Terms?
              </h2>
              <p className="text-xl mb-8 opacity-90">
                Our team is here to clarify any booking terms and help you
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-4">
                    Contact Us About Booking Terms
                  </h3>
                  <div className="space-y-2 text-sm">
                    ...
                    <p className="text-xs opacity-80 mt-4">
                      We'll respond to booking inquiries within 24 hours during
                      business days.
                    </p>
                  </div>
                </CardContent>
