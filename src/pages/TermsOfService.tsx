        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-4 opacity-90">
              Please read these terms carefully before using our services. By booking with us, you agree to these terms and conditions.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <Alert className="border-amber-200 bg-amber-50">
              ...
              <AlertDescription className="text-amber-800">
                <strong>Important:</strong> These terms constitute a legal agreement between you and {COMPANY_NAME}. 
                Please read carefully and contact us if you have any questions before booking.
              </AlertDescription>
            </Alert>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="mt-12 bg-muted/20">
              <CardContent className="p-8 text-center">
                ...
                <h2 className="font-display text-2xl mb-4">Questions About These Terms?</h2>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    We're here to clarify any terms before you book your safari with us.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mt-8 border-primary/20">
              <CardContent className="p-6">
                <h3 className="font-display text-lg font-semibold mb-3 text-primary">Legal Notice</h3>
                <p className="text-sm text-muted-foreground">
                  {COMPANY_NAME} is a licensed tour operator in Kenya. These terms are governed by Kenyan law. 
