  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="about safari company Kenya, Kenya safari experts, luxury safari tour operator, Maasai Mara safari company"
        />
        <meta
          property="og:title"
          content="About Us | Kenya Safari Experts & Luxury Tour Company"
        />
        <meta
        ...
        <section className="relative h-[50vh] bg-gradient-sunset flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-white">
            ...
            <p className="text-xl max-w-2xl mx-auto px-4">
              Born in Kenya, crafting unforgettable safari experiences for
              global adventurers since 2009
            </p>
          </div>
        </section>
          ...
          <section className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-lg mx-auto text-muted-foreground">
              <p className="text-lg leading-relaxed mb-6">
                Karen Legacy Tours & Safaris was founded with a simple mission:
                to share the raw beauty and untamed spirit of Kenya with
                travelers who seek authentic, transformative experiences.
              </p>
              <p className="text-lg leading-relaxed mb-6">
              ...
              <p className="text-lg leading-relaxed">
                ...
                Kenya is known for. We don't just show you Kenya; we help you
                feel its heartbeat.
              </p>
            </div>
          </section>
