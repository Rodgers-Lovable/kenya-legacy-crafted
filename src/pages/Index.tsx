...
import DawnDrive from "@/assets/images/dawn-drive.jpg";
  ...
  const journeyStory = [
    {
      ...
      title: "Dawn Drive",
      description:
        "As the sun paints the savanna golden, your private vehicle sets out into the awakening wilderness.",
      image: DawnDrive,
    },
    {
      time: "8:00 AM",
      ...
      description:
        "Dine under an acacia tree while elephants graze nearby, the perfect start to your adventure.",
      image: BushBreakfast,
    },
    {
      time: "6:00 AM",
      ...
      description:
        "Drift silently over the Mara as herds move like rivers across the endless plains below.",
      image: BalloonFlight,
    },
    {
      time: "6:30 PM",
