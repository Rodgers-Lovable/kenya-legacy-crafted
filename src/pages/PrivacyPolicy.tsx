...
const PrivacyPolicy = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        {
          subtitle: "Under GDPR and Kenyan data protection laws, you have the right to:",
          items: [
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <p className="text-lg leading-relaxed text-muted-foreground">
                  {COMPANY_NAME} ("<strong>we</strong>", "<strong>our</strong>", or "<strong>us</strong>") is committed to protecting your privacy. 
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="p-6 space-y-6">
                      {section.content.map((subsection, subIndex) => (
                        <div key={subIndex}>
                          <h3 className="font-semibold mb-3 text-foreground">{subsection.subtitle}</h3>
            ...
            <Card className="mt-12 bg-muted/20">
              <CardContent className="p-8 text-center">
                ...
                <h2 className="font-display text-2xl mb-4">Questions About Privacy?</h2>
            ...
            <Card className="mt-8 border-primary/20">
              <CardContent className="p-6">
                <h3 className="font-display text-lg font-semibold mb-3 text-primary">GDPR Compliance Notice</h3>
                <p className="text-sm text-muted-foreground">
                  For European Union residents: This policy complies with the General Data Protection Regulation (GDPR). 
                  You have additional rights under GDPR, including the right to lodge a complaint with your local data protection authority. 
                  Our lawful basis for processing is typically consent, contract performance, or legitimate business interests.
                </p>
              </CardContent>
            </Card>
          </div>
