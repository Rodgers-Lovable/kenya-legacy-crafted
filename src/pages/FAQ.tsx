...
const FAQ = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQs | {COMPANY_NAME}</title>
        <meta
          name="description"
          content="Find answers to the most frequently asked questions about Kenya safaris. Learn about safety, best time to visit, visa requirements, costs, and what to pack."
        />
        <meta
          name="keywords"
          content="Kenya safari FAQs, safari safety Kenya, best time for safari, Kenya visa safari, safari costs, safari packing list"
        />
      </Helmet>
