...
const SafariPreparation = () => {
  const preparationSteps = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Book international flights to Jomo Kenyatta International (NBO)",
      ...
      items: [
        {
          ...
          description: "Required if coming from endemic areas, recommended for all",
          cost: "USD $150-300",
          required: true
        },
        {
          task: "Malaria prophylaxis consultation",
          description: "Consult travel medicine doctor for appropriate medication",
  ...
  const budgetGuidelines = [
    { category: "Guide & Driver Tips", amount: "USD $15-25 per person per day", frequency: "Daily" },
    { category: "Camp/Lodge Staff Tips", amount: "USD $10-15 per person per day", frequency: "End of stay" },
    { category: "Balloon Safari Tips", amount: "USD $20-30 per person", frequency: "Per experience" },
    { category: "Souvenirs & Shopping", amount: "USD $50-200 per person", frequency: "Trip total" },
    { category: "Drinks & Extras", amount: "USD $15-30 per person per day", frequency: "Daily" }
  ];
  ...
  return (
    <div className="min-h-screen pt-16">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              Complete step-by-step preparation guide for your Kenya safari. Health, visas, packing, and insider tips.
            </p>
            
            <Alert className="bg-white/10 border-white/20 text-white max-w-2xl mx-auto">
              <Info className="h-4 w-4" />
              <AlertDescription>
                Start planning 6-8 weeks before travel for a stress-free experience. Some requirements may take time to process.
              </AlertDescription>
            </Alert>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="font-display text-3xl text-center mb-12">Preparation Timeline</h2>
                  ...
                  <CardHeader className="bg-muted/20">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge 
                        ...
                        className={step.priority === "Critical" ? "bg-red-600" : ""}
                      >
                        {step.priority}
                      </Badge>
                    </div>
                  ...
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      {step.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="flex items-start space-x-3 p-4 rounded-card border border-border hover:bg-muted/20 transition-safari">
                          <CheckCircle className={`w-5 h-5 mt-1 ${item.required ? 'text-safari-green' : 'text-muted-foreground'}`} />
      ...
      <section className="py-20 bg-muted/20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="font-display text-3xl text-center mb-12">Health & Safety Tips</h2>
                ...
                <Card key={index} className="hover:shadow-safari-floating transition-all duration-300">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <h3 className="font-display text-lg font-semibold">{category.category}</h3>
                    </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl text-center mb-12">Budget Guidelines</h2>
      ...
      <section className="py-20 bg-gradient-landscape text-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="font-display text-3xl mb-4">Need Preparation Help?</h2>
            <p className="text-xl mb-8 opacity-90">
              Our safari experts are here to guide you through every step of the preparation process.
            </p>
