        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              Everything you need for your Kenya safari adventure. Pack smart, travel light, experience more.
            </p>
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        {category.items.map((entry, itemIndex) => (
                          ...
                          >
                            <CheckCircle 
                              className={`w-5 h-5 ${
                                entry.essential ? 'text-safari-green' : 'text-muted-foreground'
                              }`} 
                            />
                            <span className={`flex-1 ${entry.essential ? 'font-medium' : ''}`}>
                              {entry.item}
                            </span>
                            {entry.essential && (
      ...
      <section className="py-20 bg-muted/20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl text-center mb-12">Seasonal Packing Tips</h2>
      ...
      <section className="py-20 bg-gradient-landscape text-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">
              Get our printable packing checklist and start preparing for your safari adventure.
            </p>
