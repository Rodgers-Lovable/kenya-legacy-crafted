            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="relative mb-8">
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  <Footprints
                    className="w-6 h-6 text-white/30 absolute top-12 right-1/3 -rotate-12 animate-pulse"
                    style={{ animationDelay: "0.5s" }}
                  />
                  <Footprints
                    className="w-10 h-10 text-white/35 absolute bottom-8 left-1/3 rotate-45 animate-pulse"
                    style={{ animationDelay: "1s" }}
                  />
                  <Footprints
                    className="w-7 h-7 text-white/40 absolute bottom-4 right-1/4 -rotate-6 animate-pulse"
                    style={{ animationDelay: "1.5s" }}
                  />
                </div>
              </div>

              <h1 className="font-display text-6xl md:text-8xl mb-4 animate-safari-fade-in">
                404
              </h1>
              <h2 className="font-display text-3xl md:text-4xl mb-6 animate-safari-fade-in">
                Lost in the{" "}
                <span className="italic text-safari-golden">Wild?</span>
              </h2>
