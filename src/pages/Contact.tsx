...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Plan Your Safari | {COMPANY_NAME}</title>
        <meta
          name="description"
          content="Get in touch with our safari experts to plan your Kenya safari adventure. Book luxury tours in Maasai Mara, Amboseli, Tsavo & more."
        />
        <meta
          name="keywords"
          content="contact safari Kenya, book safari Kenya, Kenya safari booking, Maasai Mara tour contact"
        />
        <meta
          property="og:title"
          content="Contact Us | Book Your Kenya Safari Adventure"
        />
        <meta property="og:image" content="/images/seo/contact.jpg" />
        <link
          rel="canonical"
          href="https://karenlegacytoursandsafaris.com/contact"
        />
      </Helmet>
