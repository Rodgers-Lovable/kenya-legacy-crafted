    ...
    <div className="min-h-screen pt-16">
      ...
      <section className="relative h-[40vh] bg-gradient-sunset flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="font-display text-5xl md:text-6xl font-bold mb-4">Plan Your Safari</h1>
          <p className="text-xl max-w-2xl mx-auto px-4">
            Ready to embark on your Kenya adventure? Let's create your perfect safari experience
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <Card className="border-border">
              <CardHeader>
                <CardTitle className="font-display text-3xl">Tell Us About Your Dream Safari</CardTitle>
                <p className="text-muted-foreground">
                  Complete the form below and our safari experts will create a personalized itinerary for you
                </p>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-2">Safari Style</label>
                      <Select onValueChange={(value) => setFormData({...formData, interests: value})}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="migration">Migration Safari</SelectItem>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Select onValueChange={(value) => setFormData({...formData, groupSize: value})}>
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Select onValueChange={(value) => setFormData({...formData, budget: value})}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="luxury">$4,000 - $8,000</SelectItem>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Tell us more about your safari dreams</label>
                    <Textarea
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">info@karenlegacy.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Karen Road, Nairobi<br />Kenya</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Mon-Fri: 8AM-6PM EAT<br />Sat-Sun: 9AM-4PM EAT</p>
                  </div>
                </div>
